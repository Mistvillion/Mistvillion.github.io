...
两页的 `<link rel="preload" as="font" type="font/ttf" crossorigin>` 与 CSS `@font-face` 均直接指向上述 TTF。
...
4. **编写页面**：`index.html`、`profile.html`、`assets/css/site.css`、`assets/js/site.js`，遵守"页面规范"与"字体规范"。
